...
import android.mobile.foodappclient.activity.CartActivity;
import android.mobile.foodappclient.activity.IntroActivity;
import android.mobile.foodappclient.activity.SearchActivity;
import android.mobile.foodappclient.adpater.BestfoodAdapter;
import android.mobile.foodappclient.adpater.CategoryfoodAdapter;
import android.mobile.foodappclient.adpater.PhotoAdapter;
...
import android.mobile.foodappclient.databinding.FragmentHomeBinding;
